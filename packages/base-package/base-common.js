...
FS.Store = {
  GridFS: function () {
    throw new Error('To use FS.Store.GridFS, you must add the "zcfs:gridfs" package.');
  },
  FileSystem: function () {
    throw new Error('To use FS.Store.FileSystem, you must add the "zcfs:filesystem" package.');
  },
  S3: function () {
    throw new Error('To use FS.Store.S3, you must add the "zcfs:s3" package.');
  },
  WABS: function () {
    throw new Error('To use FS.Store.WABS, you must add the "zcfs:wabs" package.');
  },
  Dropbox: function () {
    throw new Error('To use FS.Store.Dropbox, you must add the "zcfs:dropbox" package.');
  }
};
